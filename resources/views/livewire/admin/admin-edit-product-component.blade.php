                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="post" class="form-horizontal"
                              enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" name="" id=""
                                           placeholder="Product Slug" wire:model="slug" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" class="input-file" name="" id="" placeholder="Product Image" accept=".gif, .jpeg, .jpg, .png"
                                           wire:model="newimage">
                                    @if($newimage)
