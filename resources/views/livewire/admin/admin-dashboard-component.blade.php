                        ...
                        <table class="table table-striped">
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.orderdetails', ['order_id'=>$order->id])}}" class="btn btn-info btn-sm">Details</a></td>                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                    </div>
...
<!--        Warehouse-->
        <div class="row">
            <center><h1>Warehouse</h1></center>
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Total Categories</span>
                            <span class="icon-stat-value">{{$totalCategories}}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                    ...
                    <div class="icon-stat-footer">
                        <a href="{{route('admin.categories')}}"><i class="fa fa-clock-o"></i> View Categories</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value">{{$totalBrands}}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                            <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                        </div>
                    ...
                    <div class="icon-stat-footer">
                        <a href="{{route('admin.brands')}}"><i class="fa fa-clock-o"></i> View Brands</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value">{{$totalProducts}}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                            <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                        </div>
                    ...
                    <div class="icon-stat-footer">
                        <a href="{{route('admin.products')}}"><i class="fa fa-clock-o"></i> View Products</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            ...
                            <span class="icon-stat-value">{{$totalUsers}}</span>
                        </div>
                        <div class="col-xs-4 text-center">
                            <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                        </div>
                    ...
                    <div class="icon-stat-footer">
                        <a href=""><i class="fa fa-clock-o"></i> View Users</a>
                    </div>
                </div>
            </div>
        </div>
