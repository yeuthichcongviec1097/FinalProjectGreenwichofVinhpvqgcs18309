...
class CategoryComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.category-component', ['products' => $products, 'categories' => $category, 'brands'=>$brands, 'category_name'=> $category_name, 'sale'=>$sale, 'l_products'=>$l_products])->layout("layouts.base");
    }
}
