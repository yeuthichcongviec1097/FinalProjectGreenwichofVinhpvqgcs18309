            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="#" class="banner-link">
                        @if($category_slug == "gaming-laptop")
                            <figure><img src="{{asset('assets/images/category-gaming-laptops-banner.jpg')}}" alt="gaming-laptops"></figure>
                        @elseif($category_slug == "gaming-desktop")
                            <figure><img src="{{asset('assets/images/category-gaming-desktops-banner.jpg')}}" alt="gaming-desktops"></figure>
                        @elseif($category_slug == "gaming-monitor")
                            <figure><img src="{{asset('assets/images/category-gaming-monitors-banner.jpg')}}" alt="gaming-monitors"></figure>
                        @endif
                    </a>
                </div>
                                ...
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details', [$product->slug])}}" class="product-name"><span style="display:inline-block;
                                                                                                                                ...
                                                                                                                                max-width: 34ch;" title="{{$product->name}}">{{$product->name}}</span></a>
                            ...
                            @foreach($brands as $brand)
                                <li class="category-item">
                                    <img src="{{asset('assets/images/brands')}}/{{$brand->image}}"
                                         alt="{{$brand->name}}" width="30px" style="padding-right: 5px !important;">
                                    <a href="{{route('product.brand', ['brand_slug'=>$brand->slug])}}" class="cate-link">{{$brand->name}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="widget-banner">
                            <figure><img src="{{asset('assets/images/razer_gaming_pull_up_banner_by_gierka_design_d3gc0gz-fullview.jpg')}}" width="270" height="331" alt=""></figure>
                        </div>
                    </div>
                </div><!-- Size -->
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="detail.html" title="{{$l_product->name}}">
                                                <figure><img src="{{asset('assets/images/products/')}}/{{$l_product->image}}" alt="{{$l_product->name}}"></figure>
                                            </a>
                                        </div>
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>{{$l_product->name}}</span></a>
                                            @if($l_products->count() > 0 && $sale->status == 1 && $sale->sale_date > \Carbon\Carbon::now() && $l_product->sale_price > 0)
                                                <div class="wrap-price">
                                                    <ins><p class="product-price">${{$l_product->sale_price}}</p></ins>
                                                    <del><p class="product-price">${{$l_product->regular_price}}</p></del>
                                                </div>
                                            @else
