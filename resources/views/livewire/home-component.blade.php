<main id="main">
    <div class="container">
                ...
                @foreach ($sliders as $slide)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            <h2 class="f-title" style="color: #ff5a5a !important;">{{$slide->title}}</b></h2>
                            <span class="subtitle" style="color: #ff3535 !important;">{{$slide->subtitle}}</span>
                            <p class="sale-info color-sale-info">Only price: <span class="price">${{$slide->price}}</span></p>
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="assets/images/gaming-gear-banner.jpg" width="1170" height="240" alt="">
                    </figure>
                </a>
            </div>
                                ...
                                @foreach($lproducts as $lproduct)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            @if($lproducts->count() > 0 && $sale->status == 1 && $sale->sale_date > \Carbon\Carbon::now() && $lproduct->sale_price > 0)
                                                <div class="wrap-price">
                                                    <ins><p class="product-price">${{$lproduct->sale_price}}</p></ins>
                                                    <del><p class="product-price">${{$lproduct->regular_price}}</p></del>
                                                </div>
                                            @else
                                                <div class="wrap-price">
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="assets/images/AWD-IT Gaming PC Banner.jpg" width="1170" height="240" alt="">
                    </figure>
                </a>
            </div>
            <div class="wrap-products">
                        ...
                        @foreach($categories as $key=>$category)
                            <div class="tab-content-item {{$key==0 ? 'active':''}}" id="category_{{$category->id}}">
                                <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                    ...
                                    @php
                                        $c_products = DB::table('products')->where('category_id', $category->id)->orderBy('created_at', 'DESC')->get()->take($no_of_products);
                                    @endphp
                                    @foreach($c_products as $c_product)
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                @if($c_products->count() > 0 && $sale->status == 1 && $sale->sale_date > \Carbon\Carbon::now() && $c_product->sale_price > 0)
                                                    <div class="wrap-price">
                                                ...
                                                @else
                                                    <div class="wrap-price">
                                                        <span class="product-price">${{$c_product->regular_price}}</span>
                                                    </div>
                                                @endif
