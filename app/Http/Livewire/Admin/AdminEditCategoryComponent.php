...
class AdminEditCategoryComponent extends Component
{
    ...
    public function updateCategory(){
        ...
        if($this->scategory_id){
            ...
            $this->emit('alert', ['type' => 'success', 'message' => 'Sub-Category has been updated successfully !!!']);
        }else{
            ...
            $this->emit('alert', ['type' => 'success', 'message' => 'Category has been updated successfully !!!']);
        }
